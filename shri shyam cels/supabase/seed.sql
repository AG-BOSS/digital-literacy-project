-- ==============================================================================
-- SHRI SHYAM CELEBRATIONS – INITIAL DATA SEED SCRIPT (Pure SQL / Idempotent)
-- Populates categories, subcategories, and migrated products from src/data/products.ts
-- Safe to run standalone or after migrations.
-- ==============================================================================

-- 0. SCHEMA PREREQUISITES (Ensures tables & indexes exist so seed NEVER fails)
